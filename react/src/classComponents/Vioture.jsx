...
class Vioture extends Component {
    constructor(props) {
        super(props);
        this.state = {matricule : "123456", marque : "BMW", chevaux : "200"};
        }
    render() {
        return (
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        this is the matricule : {this.state.matricule}
                    </li>
                    <li
                    className=' text-slate-900 text-lg font-bold'
                    >
                        this is the marque : {this.state.marque}
                    </li>
                    <li
                    className=' text-slate-900 text-lg font-bold'
                    >
                        this is the chevaux : {this.state.chevaux}
                    </li>
                </ul>
            </div>
        );
